    ...
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,TimeStamp,Text,RowVersion")] NewsItem newsItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException e)
                {
                    ...
                    {
                        ModelState.AddModelError("", "The data being edited has been modified or deleted by another user.");
        ...
        public async Task<IActionResult> DeleteConfirmed(int id, NewsItem newsItem)
        {
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                {
                    ModelState.AddModelError("", "Unable to delete the record. It was modified by another user after you fetched the original value.");
